...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <h1 className="font-poppins font-semibold ss:text-[67px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">
        Payment Method.
      </h1>
      ...
      <div className="absolute z-[3] -left-1/2 top-[40%] w-[50%] h-[20%] rounded-full white__gradient" />
    </div>
